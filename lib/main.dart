          ...
          if (args is Map<String, dynamic> && args['passengerId'] != null) {
            return MaterialPageRoute(
              builder: (context) => LiveMapScreen(
                ...
                busRouteGeoJsonUrl: args['busRouteGeoJsonUrl'],
                routeStops: args['routeStops'],
                selectedBusNumberPlate: args['selectedBusNumberPlate']
              ),
            );
          } else {
            return MaterialPageRoute(
        ...
        if (settings.name == '/favourites') {
          ...
          return MaterialPageRoute(
            builder: (context) => FavouriteScreen(
              passengerId: args?['passengerId'] ?? '',
              initialShowBuses: args?['showBuses'], // <-- THIS IS THE FIX
            ),
          );
        }
